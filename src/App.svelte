<script>
	...
	function setBackground(){
		let background = `
			...
			url(./files/img/${$musicList[currentSongIndex].image}) center no-repeat
		`;
...
<style>
	...
	.player .song-list {
		...
		box-shadow: 0px 8px 32px 0 rgba(32,38,125,0.2);
	...
	.player .song-list::webkit-scroll-thumb {
		width: 4px;
		background: #fff;
	}
...
<main bind:this={mainElement}>
	...
	<div class="player">
		<div class="current-song">
			<div class="avatar">
				<img src={"./files/img/" + $musicList[currentSongIndex].image}>
			</div>
